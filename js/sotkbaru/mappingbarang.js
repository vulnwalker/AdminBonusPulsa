var MappingBarangSkpd = new SkpdCls({
	prefix : 'MappingBarangSkpd', formName:'MappingBarangForm'
});


var MappingBarang = new DaftarObj2({
	prefix : 'MappingBarang',
	url : 'pages.php?Pg=mappingbarang', 
	formName : 'MappingBarangForm',
		...
		$.ajax({
		  ...
		  success: function(data) {
			var resp = eval('(' + data + ')');	//console.info(me);	//console.info('id='+me.prefix+'CbxBagian');
				...
				me.refreshList(true);
				document.getElementById('MappingBarangfmSKPDBidang2').innerHTML=resp.content;
				me.BidangAfter2();
		...
		$.ajax({
		  ...
		  success: function(data) {
			var resp = eval('(' + data + ')');	//console.info(me);	//console.info('id='+me.prefix+'CbxBagian');
				...
				me.refreshList(true);
				document.getElementById('MappingBarangfmSKPDskpd2').innerHTML=resp.content;
				me.SKPDAfter2();
		...
		$.ajax({
		  ...
		  success: function(data) {
			var resp = eval('(' + data + ')');	//console.info(me);	//console.info('id='+me.prefix+'CbxBagian');
				...
				me.refreshList(true);
				document.getElementById('MappingBarangfmSKPDUnit2').innerHTML=resp.content;
				me.UnitAfter2();
		...
		$.ajax({
		  ...
		  success: function(data) {
			var resp = eval('(' + data + ')');	//console.info(me);	//console.info('id='+me.prefix+'CbxBagian');
				...
				me.refreshList(true);
				document.getElementById('MappingBarangfmSKPDSubUnit2').innerHTML=resp.content;
	...
	var me =this;
		...
		if(jmlcek ==0){
			...
			if(confirm('Mapping '+jmlcek+' Data ?')){
				//errmsg = this.CekCheckbox();
				errmsg = '';
	
				c1 = document.getElementById('MappingBarangfmSKPDUrusan');
				c2 = document.getElementById('MappingBarangfmSKPDBidang2');
				d2 = document.getElementById('MappingBarangfmSKPDskpd2');
				e2 = document.getElementById('MappingBarangfmSKPDUnit2');
				e12 = document.getElementById('MappingBarangfmSKPDSubUnit2');
				
				/*if(errmsg == '' && c1.value == '00')errmsg = "URUSAN Belum Diisi ! ";
				if(errmsg == '' && c2.value == '00')errmsg = "BIDANG Belum Diisi ! ";
				if(errmsg == '' && d2.value == '00')errmsg = "SKPD Belum Diisi ! ";
				if(errmsg == '' && e2.value == '00')errmsg = "UNIT Belum Diisi ! ";
				if(errmsg == '' && e12.value == '000')errmsg = "SUB UNIT Belum Diisi ! ";*/
