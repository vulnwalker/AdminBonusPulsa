var ref_kode_barang_mappingkpd = new SkpdCls({
	prefix : 'ref_kode_barang_mappingSkpd', formName:'ref_kode_barang_mappingForm'
});


var ref_kode_barang_mapping = new DaftarObj2({
	prefix : 'ref_kode_barang_mapping',
	url : 'pages.php?Pg=ref_kode_barang_mapping', 
	formName : 'ref_kode_barang_mappingForm',
