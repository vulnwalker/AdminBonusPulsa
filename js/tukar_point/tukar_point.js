...
var tukar_point = new DaftarObj2({
	prefix : 'tukar_point',
	url : 'pages.php?Pg=tukar_point',
	//formName : 'tukar_point_form',
	formName : 'tukar_pointForm',
	//tukar_point_form
	loading: function(){
		//alert('loading');
		this.topBarRender();
	...
	Baru: function(){
		...
		if (err =='' ){
			...
			$.ajax({
				type:'POST',
				data:$('#tukar_point_form').serialize(),
...
PemdaEdit: function(){
		...
		if (err =='' ){
			...
			$.ajax({
				type:'POST',
				data:$('#tukar_point_form').serialize()+"&idPemda="+$("#cmbPemda").val(),
			  	url: this.url+'&tipe=formBaruPemda',
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					document.getElementById(cover).innerHTML = resp.content;
...
AplikasiEdit: function(){
		...
		if (err =='' ){
			...
			$.ajax({
				type:'POST',
				data:$('#tukar_point_form').serialize()+"&idAplikasi="+$("#cmbAplikasi").val(),
			  	url: this.url+'&tipe=formBaruAplikasi',
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					document.getElementById(cover).innerHTML = resp.content;
	...
	Edit:function(){
		...
		if(errmsg ==''){
			...
			$.ajax({
				type:'POST',
				data:$('#tukar_pointForm').serialize(),
