...
var hadiah = new DaftarObj2({
	prefix : 'hadiah',
	url : 'pages.php?Pg=hadiah',
	//formName : 'hadiah_form',
	formName : 'hadiahForm',
	//hadiah_form
	loading: function(){
		//alert('loading');
...
PemdaEdit: function(){
		...
		if (err =='' ){
			...
			$.ajax({
				type:'POST',
				data:$('#hadiah_form').serialize()+"&idPemda="+$("#cmbPemda").val(),
			  	url: this.url+'&tipe=formBaruPemda',
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					document.getElementById(cover).innerHTML = resp.content;
...
AplikasiEdit: function(){
		...
		if (err =='' ){
			...
			$.ajax({
				type:'POST',
				data:$('#hadiah_form').serialize()+"&idAplikasi="+$("#cmbAplikasi").val(),
			  	url: this.url+'&tipe=formBaruAplikasi',
			  	success: function(data) {
					var resp = eval('(' + data + ')');
					document.getElementById(cover).innerHTML = resp.content;
