    ...
    switch ($Pg) {
        case "brg" : {
			if (CekLogin ()) {  setLastAktif();
				...
				header("Locati00.on:index.php?");//header("Location: http://$Main->SITE/");
			}
        	break;
        }
        case "map" : {
		...
		case 'rkpd':{
			...
			if (CekLogin(FALSE) && $Main->MODUL_PERENCANAAN ) {  setLastAktif();
				...
				/*if($Main->PP27_PERENCANAAN){
					include("pages/perencanaan/fnrkpd.php"); //break;
					$rkb->selector();
				}else{*/
					include("pages/perencanaan/rkpd.php"); //break;
					$rkpd->selector();
				/*}*/
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
...
case 'refakun': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/master/ref_jurnal/ref_jurnal.php"); //break;	//echo $UserAktivitas->pageShow();
				$RefAkun->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
	...
	//			$wilayah->selector();
		...
		case 'refrekening': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/master/ref_aset/refrekening.php"); //break;	//echo $UserAktivitas->pageShow();
		...
		case 'popupBarang': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/refstandarharga/refbarang.php');
				$popupBarang->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'popupProgram': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include('pages/perencanaan/popupProgram.php');
				$popupProgram->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		}
		case 'listProgramKegiatan':{
			if (CekLogin()) {
			    setLastAktif();
				include('common/daftarobj.php');
				include("pages/master/ref_renja/list_programKegiatan.php"); //break;
				$listProgramKegiatan->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_renja': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_renja/ref_renja.php');
				$ref_renja->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'ref_urusan_renja': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_urusan_renja/ref_urusan_renja.php');
				$ref_urusan_renja->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		}
		case 'ref_dokumenSumber': {
			if (CekLogin() ) {
				setLastAktif();
				include_once('common/daftarobj.php');
				include("pages/master/refDokumenSumber/dokumenSumber.php"); //break;	//echo $UserAktivitas->pageShow();
				$dokumenSumber->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_programKegiatan': {
			if (CekLogin() ) {
				setLastAktif();
				include_once('common/daftarobj.php');
				include("pages/master/ref_programKegiatan/programKegiatan.php"); //break;	//echo $UserAktivitas->pageShow();
				$programKegiatan->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_penyedia': {
			if (CekLogin() ) {
				setLastAktif();
				include_once('common/daftarobj.php');
				include("pages/master/ref_penyedia/penyedia.php"); //break;	//echo $UserAktivitas->pageShow();
				$penyedia->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
	...
	case 'refclosingdata': {
		...
		case 'ref_kode_gaji': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/master/ref_kode_gaji/ref_kode_gaji.php"); //break;	//echo $UserAktivitas->pageShow();
				$ref_kode_gaji->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
...
//echo "test";
		...
		case 'belanja_gaji': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/pengaturan_belanja_gaji/belanja_gaji.php');
				$belanja_gaji->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		/*case 'gaji': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_kode_gaji.php');
				$gaji->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'pangkat': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_pangkat/pangkat.php');
				$Pangkat->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'jabatan': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_jabatan/jabatan.php');
				$Jabatan->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 't_pegawai': {
			if (CekLogin(TRUE)) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/pegawai/t_pegawai.php');
				$t_pegawai->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 't_keluarga': {
			if (CekLogin(TRUE)) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/pegawai/t_keluarga.php');
				$t_keluarga->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'sotkbaru_ins': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/sotkbaru/sotkbaru_ins.php');
				$SOTKBaru_ins->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_sotk_lama': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_sotk_lama/ref_sotk_lama.php');
				$ref_sotk_lama->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
			...
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_sotk_baru/ref_sotk_baru.php');
				$ref_sotk_baru->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_barang_lama': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_barang_lama/ref_barang_lama.php');
				$ref_barang_lama->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_barang_baru': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_barang_baru/ref_barang_baru.php');
				$ref_barang_baru->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_barang_lama_lvl4': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_barang_lama/ref_barang_lama_lvl4.php');
				$ref_barang_lama_lvl4->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_barang_lama_rincian': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_barang_lama/ref_barang_lama_rincian.php');
				$ref_barang_lama_rincian->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'mappingbarang':{
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/sotkbaru/mappingbarang.php"); //break;	//echo $UserAktivitas->pageShow();
				$MappingBarang->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		}
		case 'mappingbarang_ins':{
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/sotkbaru/mappingbarang_ins.php"); //break;	//echo $UserAktivitas->pageShow();
				$MappingBarang_ins->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_kode_barang_mapping': {
			if (CekLogin()) {  setLastAktif();
				include('common/daftarobj.php');
				include('pages/master/ref_kode_barang_mapping/ref_kode_barang_mapping.php');
				$ref_kode_barang_mapping->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'cariBarangBaru':{
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/sotkbaru/cariBarangBaru.php"); //break;	//echo $UserAktivitas->pageShow();
				$cariBarangBaru->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'linker': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/linker/linker.php"); //break;	//echo $UserAktivitas->pageShow();
				$linker->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'aplikasi': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/aplikasi/aplikasi.php"); //break;	//echo $UserAktivitas->pageShow();
				$aplikasi->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'cek_aplikasi': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/cek_aplikasi/cek_aplikasi.php"); //break;	//echo $UserAktivitas->pageShow();
				$cek_aplikasi->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		}
		case 'cek_aplikasi_pemda': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/cek_aplikasi/cek_aplikasi_pemda.php"); //break;	//echo $UserAktivitas->pageShow();
				$cek_aplikasi_pemda->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'cekAplikasi': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/cekAplikasi/cekAplikasi.php"); //break;	//echo $UserAktivitas->pageShow();
				$cekAplikasi->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'rincianCek': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/cekAplikasi/rincianCek.php"); //break;	//echo $UserAktivitas->pageShow();
				$rincianCek->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'po': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/po/po.php"); //break;	//echo $UserAktivitas->pageShow();
				$po->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'administrasi': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/po/administrasi.php"); //break;	//echo $UserAktivitas->pageShow();
				$administrasi->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'rd': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/po/rd.php"); //break;	//echo $UserAktivitas->pageShow();
				$rd->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'mt': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/po/mt.php"); //break;	//echo $UserAktivitas->pageShow();
				$mt->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'pemda': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/po/pemda.php"); //break;	//echo $UserAktivitas->pageShow();
				$pemda->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'rincianPekerjaan': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/po/rincianPekerjaan.php"); //break;	//echo $UserAktivitas->pageShow();
				$rincianPekerjaan->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'hak_akses': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/hak_akses/hak_akses.php"); //break;	//echo $UserAktivitas->pageShow();
				$hak_akses->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'ref_pemda': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/ref_pemda/ref_pemda.php"); //break;	//echo $UserAktivitas->pageShow();
				$ref_pemda->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
		...
		case 'ref_aplikasi': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/ref_aplikasi/ref_aplikasi.php"); //break;	//echo $UserAktivitas->pageShow();
				$ref_aplikasi->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_aplikasi_pemda': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/ref_aplikasi_pemda/ref_aplikasi_pemda.php"); //break;	//echo $UserAktivitas->pageShow();
				$ref_aplikasi_pemda->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'popupOption': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/ref_aplikasi_pemda/popupOption.php"); //break;	//echo $UserAktivitas->pageShow();
				$popupOption->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'pengguna_aplikasi': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/pengguna_aplikasi/pengguna_aplikasi.php"); //break;	//echo $UserAktivitas->pageShow();
				$pengguna_aplikasi->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'rencana_pengembangan': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/rencana_pengembangan/rencana_pengembangan.php"); //break;	//echo $UserAktivitas->pageShow();
				$rencana_pengembangan->selector();
			}else{
				header("Location:index.php?");//header("Location: http://$Main->SITE/");
			}
			break;
		...
		case 'ref_pegawai': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/ref_pegawai/ref_pegawai.php");
				$ref_pegawai->selector();
			}else{
				header("Location:index.php?");
			}
			break;
    ...
    case 'penukaran': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/penukaran/penukaran.php");
				$penukaran->selector();
			}else{
				header("Location:index.php?");
			}
    ...
    case 'histori_iklan': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/histori_iklan/histori_iklan.php");
				$histori_iklan->selector();
			}else{
				header("Location:index.php?");
			}
			break;
    ...
    case 'hadiah': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/hadiah/hadiah.php");
				$hadiah->selector();
			}else{
				header("Location:index.php?");
			}
    ...
    case 'tukar_point': {
			if (CekLogin() ) {
				setLastAktif();
				include('common/daftarobj.php');
				include("pages/tukar_point/tukar_point.php");
				$tukar_point->selector();
			}else{
				header("Location:index.php?");
			}
			break;
