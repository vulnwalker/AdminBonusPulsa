...
class ref_tandatanganObj  extends DaftarObj2{	
   ...
   /*$dt=array();
	...
	$cek ='';
		...
		$this->form_fmST = 1;				
		//get data 
		$aqry = "SELECT * FROM  ref_tandatangan WHERE c='$c' and d='$d' and e='$e' and e1='$e1' "; $cek.=$aqry;
		$dt = mysql_fetch_array(mysql_query($aqry));
		$fm = $this->setForm($dt);
       ...
       //items ----------------------
		 $this->form_fields = array(
			'kode' => array( 
						...
						//'type'=>'text',
						'value'=>
						"<input type='text' name='c' id='c' size='3' maxlength='2' value='".$kode1."' $readonly>&nbsp
						<input type='text' name='d' id='d' size='3' maxlength='2' value='".$kode2."' $readonly>&nbsp
						<input type='text' name='e' id='e' size='3' maxlength='2' value='".$kode3."' $readonly>&nbsp
						<input type='text' name='e1' id='e1' size='3' maxlength='3' value='".$kode4."' $readonly>"
						 ),
			...
			'nama' => array( 
						...
						'value'=>"<input type='text' name='nama' id='nama' size='40' maxlength='100' value='".$nama."'>",
			...
			'nip' => array( 
						...
						'value'=>"<input type='text' name='nip' id='nip' size='40' maxlength='100' value='".$nip."'>",
						'row_params'=>"valign='top'",
						'type'=>'' 
									 ),		
			 /*'jabatan' => array( 
						...
						'value'=>"<input type='text' name='jabatan' id='jabatan' size='40' maxlength='100' value='".$jabatan."'>",
						'row_params'=>"valign='top'",
						'type'=>'' 
									 ),*/
			'jabatan' => array( 
						...
						'labelWidth'=>50, 
						'value'=>
						cmb2Dv2('jabatan',$jabatan,$Arrjbt,''),
						
						'row_params'=>"valign='top'",
						'type'=>'' 
						
						/*<select id="jenis" name="jenis">
						<option value="1. Kepala SKPD">1. Kepala SKPD</option>
						<option value="2. Pengurus Barang">2. Pengurus Barang</option>;*/
						/*cmbArray('1.','Kepala SKPD'
									'2.','Pengurus Barang');*/
