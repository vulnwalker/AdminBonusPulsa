...
class popupBarangObj  extends DaftarObj2{	
	var $Prefix = 'popupBarang';
	...
	function setPage_OtherScript(){
		...
		return 
			 "
			 <script type='text/javascript' src='js/master/ref_template/jquery.js' language='JavaScript' ></script> <script type='text/javascript' src='js/master/refstandarharga/refbarang.js' language='JavaScript' ></script>".
...
/*			'' => array( 
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 if($isi['j'] == '000'){
 	 ...
 	 $Koloms[] = array('align="left" width="200"',"<a style='cursor:pointer;' onclick = popupBarang.windowSave('$kode_barang')>". $isi['nm_barang']. "</a>");
...
$popupBarang = new popupBarangObj();
