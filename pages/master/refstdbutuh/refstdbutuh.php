...
class refstdbutuhObj  extends DaftarObj2{	
	...
	function setFormBaru(){
  	...
  	function setFormEdit(){
		...
		$aqry = "select * from ref_std_kebutuhan where concat(c1,' ',c,' ',d,' ',e,' ',e1,' ',f1,' ',f2,' ',f,' ',g,' ',h,' ',i,' ',j) ='".$this->form_idplh."' "; $cek.=$aqry;
...
$comboBoxSubUnit =  cmbQuery('cmbSubUnitForm', $selectedSubUnit, $codeAndNameSubUnit,' '.$cmbRo.' onChange=\''.$this->Prefix.'.BidangAfterform()\'','-- Pilih Semua --');          
		  ...
		  $this->form_fields = array(
			...
			'satuan' => array(
				...
				'jumlah' => array( 
						'label'=>'JUMLAH',
						'labelWidth'=>120, 
						'value'=> "<input type='text' name='jumlah' id='jumlah' value='$jumlah' onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup='document.getElementById(`bantu`).innerHTML = popupBarang.formatCurrency2(this.value);' style='text-align:right'> <font color='red' id='bantu' name='bantu'></font>"  
							  ),									 	
	...
	function setKolomData($no, $isi, $Mode, $TampilCheckBox){
	 ...
	 $Koloms[] = array('align="center" width="100" ',$isi['f1'].".".$isi['f2'].".".$isi['f'].".".$isi['g'].".".$isi['h'].".".$isi['i'].".".$isi['j']);
	...
	$fmBARANG = $_REQUEST['fmBARANG'];
		...
		$arrOrders[] = " concat(ref_std_kebutuhan.f,'.',ref_std_kebutuhan.g,'.',ref_std_kebutuhan.h,'.',ref_std_kebutuhan.i,'.',ref_std_kebutuhan.j) ASC " ;
