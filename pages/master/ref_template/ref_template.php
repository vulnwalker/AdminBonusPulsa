	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'BidangAfter':{
			...
			setcookie('VulnWalkerUrusan','0');
			setcookie('VulnWalkerBidang','00');
			setcookie('VulnWalkerSkpd','00');	
			setcookie('VulnWalkerUnit','00');
			setcookie('VulnWalkerUnit','00');
	...
	function setForm($dt){	
	 ...
	 $kemanaCoba = $this->Prefix.".Simpan()";
		...
		$valEditTanggal = $dt['tgl'];
			...
			setcookie('VulnWalkerUrusan',$selectedUrusan);
			setcookie('VulnWalkerBidang',$selectedBidang);
			setcookie('VulnWalkerSkpd',$selectedskpd);	
			setcookie('VulnWalkerUnit',$selectedUnit);
