...
$fmSKPD2 = cekPOST("fmSKPD2","");
$fmUNIT2 = cekPOST("fmUNIT2","");
$fmSUBUNIT2 = cekPOST("fmSUBUNIT2","");
$fmSEKSI2 = cekPOST("fmSEKSI2","");
...
$fmGROUPPENGGUNA2 = cekPOST("fmGROUPPENGGUNA2","");
	...
	if($BARU == "1" || $BARU=="0")
	{
		...
		else
		{
			...
			else
			{
				...
				uid,password,nama,level,`group`,`group2`,modul01,modul02,modul03,modul04,modul05,modul06,modul07,modul08,modul09,modul10,modul11,modul12,modul13,modulref,moduladm,status)values(
				'$fmKODEPENGGUNA','$PWD','$fmNAMAPENGGUNA','$fmLEVELPENGGUNA','$fmGROUPPENGGUNA','$fmGROUPPENGGUNA2',
				'$fmMODUL01','$fmMODUL02','$fmMODUL03','$fmMODUL04','$fmMODUL05','$fmMODUL06',
				'$fmMODUL07','0','0','0','0','0','0','0','$fmMODULadm','$fmStatus'
					)");
				}
				if($BARU=="0")
				{
...
if($Act == "Add")
{
	...
	$fmSANDIPENGGUNA = "";
	$fmLEVELPENGGUNA = "";
	$fmGROUPPENGGUNA = $fmSKPD.".".$fmUNIT.".".$fmSUBUNIT.".".$fmSEKSI;
	$fmGROUPPENGGUNA2 = $fmURUSAN.".".$fmSKPD2.".".$fmUNIT2.".".$fmSUBUNIT2.".".$fmSEKSI2;
	$fmMODUL01 = "0";
	$fmMODUL02 = "0";
	$fmMODUL03 = "0";
	$fmMODUL04 = "0";
...
/*$kondSKPD = $fmSKPD != '' ? $fmSKPD.'.' : '';
$kondUNIT = $fmUNIT != '' ? $fmUNIT.'.' : '';
$kondSUBUNIT = $fmSUBUNIT != '' ? $fmSUBUNIT.'.' : '';
$kondSEKSI = $fmSEKSI != '' ? $fmSEKSI : '';*/
$arrkond= array();
$arrkond1= array();
$cek .= '$fmskpd="'.$fmSKPD.'"';
if($fmSKPD != '' && $fmSKPD !='00' ) {
	...
	if($fmUNIT != '' && $fmUNIT !='00') {
		...
		if($fmSUBUNIT != ''  && $fmSUBUNIT !='00') {
			$arrkond1[] = $fmSUBUNIT;
			if($fmSEKSI != ''  && $fmSEKSI !=$kdSubUnit0 ) $arrkond1[] = $fmSEKSI ;
		}
	}
}
if($fmURUSAN != '' && $fmURUSAN !='0' ) {
	$arrkond[] = $fmURUSAN;
	if($fmSKPD2 != '' && $fmSKPD2 !='00' ) {
		$arrkond[] = $fmSKPD2;
		if($fmUNIT2 != '' && $fmUNIT2 !='00') {
			$arrkond[] = $fmUNIT2;
			if($fmSUBUNIT2 != ''  && $fmSUBUNIT2 !='00') {
				$arrkond[] = $fmSUBUNIT2;
				if($fmSEKSI2 != ''  && $fmSEKSI2 !=$kdSubUnit0 ) $arrkond[] = $fmSEKSI2 ;
			}
		}
	}
}
$Kondisi1 = join('.',$arrkond);
$Kondisi2 = join('.',$arrkond1);
$Kondisi = "`group` like '$Kondisi2%'"; //$cek .= $Kondisi1;
$Kondisii = " and `group2` like '$Kondisi1%'"; //$cek .= $Kondisi1;
//$Kondisi = "`group` like '$Kondisi1%'"; //$cek .= $Kondisi1;
//$Kondisi = "`group` = '$fmSKPD.$fmUNIT.$fmSUBUNIT.$fmSEKSI'";
//$Kondisi = "`group` like '$kondSKPD$kondUNIT$kondSUBUNIT$kondSEKSI'";
...
$ListSUBUNIT = cmbQuery1("fmSUBUNIT",$fmSUBUNIT,"select e,nm_skpd from ref_skpd where c='$fmSKPD' and d ='$fmUNIT' and e != '00' and e1='$kdSubUnit0'","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListSEKSI = cmbQuery1("fmSEKSI",$fmSEKSI,"select e1,nm_skpd from ref_skpd where c='$fmSKPD' and d ='$fmUNIT' and e = '$fmSUBUNIT' and e1!='$kdSubUnit0' ","onChange=\"adminForm.submit()\" ",'Pilih Semua',$kdSubUnit0);

$ListURUSAN = cmbQuery1("fmURUSAN",$fmURUSAN,"select c1,nm_skpd from ref_skpd_baru where c1!='0' and c2='00' and d2 ='00' and e2 = '00' ","onChange=\"adminForm.submit()\" ",'Pilih Semua','0');
$ListSKPD2 = cmbQuery1("fmSKPD2",$fmSKPD2,"select c2,nm_skpd from ref_skpd_baru where c1='$fmURUSAN' and c2!='00' and d2 ='00' and e2 = '00' ","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListUNIT2 = cmbQuery1("fmUNIT2",$fmUNIT2,"select d2,nm_skpd from ref_skpd_baru where c1='$fmURUSAN' and c2='$fmSKPD2' and d2 !='00' and e2 = '00'  ","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListSUBUNIT2 = cmbQuery1("fmSUBUNIT2",$fmSUBUNIT2,"select e2,nm_skpd from ref_skpd_baru where c1='$fmURUSAN' and c2='$fmSKPD2' and d2 ='$fmUNIT2' and e2 != '00' and e12='$kdSubUnit0'","onChange=\"adminForm.submit()\" ",'Pilih Semua','00');
$ListSEKSI2 = cmbQuery1("fmSEKSI2",$fmSEKSI2,"select e12,nm_skpd from ref_skpd_baru where c1='$fmURUSAN' and c2='$fmSKPD2' and d2 ='$fmUNIT2' and e2 = '$fmSUBUNIT2' and e12!='$kdSubUnit0' ","onChange=\"adminForm.submit()\" ",'Pilih Semua',$kdSubUnit0);
...
$aqry = "select * from admin where $Kondisi $Kondisii order by `group` $LimitHalPENGGUNA "; $cek.= $aqry;
...
<tr>
	<td width=\"60%\" valign=\"top\">
		...
		<tr valign='top'><td width=\"50%\"><h2>SOTK LAMA</h2><br>
		<table>
			<tr>
			...
			<td WIDTH='10%'>SUB UNIT</td>
				<td WIDTH='1%'>:</td>
				<td WIDTH='89%'>$ListSEKSI</td>
			</tr>
		</table></td>
		<td width=\"50%\"><h2>SOTK BARU</h2><br>
		<table>
			<tr>
			<td WIDTH='10%'>URUSAN</td>
				<td WIDTH='1%'>:</td>
				<td WIDTH='89%'>$ListURUSAN</td>
			</tr>
			<tr>
			<td WIDTH='10%'>BIDANG</td>
				<td WIDTH='1%'>:</td>
				<td WIDTH='89%'>$ListSKPD2</td>
			</tr>
			<tr>
			<td WIDTH='10%'>SKPD</td>
				<td WIDTH='1%'>:</td>
				<td WIDTH='89%'>$ListUNIT2</td>
			</tr>
			<td WIDTH='10%'>UNIT</td>
				<td WIDTH='1%'>:</td>
				<td WIDTH='89%'>$ListSUBUNIT2</td>
			</tr>
			<td WIDTH='10%'>SUB UNIT</td>
				<td WIDTH='1%'>:</td>
				<td WIDTH='89%'>$ListSEKSI2</td>
			</tr>
		</table>
		</td></tr>
		</table>
		...
		<table width=\"100%\" height=\"100%\" class=\"adminlist\">
			<tr>
				...
				<th width='5%' class=\"title\"><div align=center>SOTK Lama</div></th>
				<th width='5%' class=\"title\"><div align=center>SOTK Baru</div></th>
...
if($Act=="Baru" || $Act=="Tambah" || $Act=="TambahEdit"|| $Act=="Add"|| ($Act=="Edit" && !empty($fmID)))
{
	...
	<table width=\"100%\" height=\"100%\" class=\"adminform\">
		...
		<tr>
			<td WIDTH='200'>Group 2</td>
			<td WIDTH='1%'>:</td>
			<td ><INPUT TYPE='text' NAME='fmGROUPPENGGUNA2' value='$fmGROUPPENGGUNA2'></td>
		</tr>
		<tr>
			<td WIDTH='200'>Modul 01. Referensi SOTK Lama</td>
			<td WIDTH='1%'>:</td>
			<td >
		...
		<tr>
			<td WIDTH='200'>Modul 02. Referensi SOTK Baru</td>
			<td WIDTH='1%'>:</td>
			<td >
		...
		<tr>
			<td WIDTH='200'>Modul 03. Referensi Kode Barang Lama</td>
			<td WIDTH='1%'>:</td>
			<td >
		...
		<tr>
			<td WIDTH='200'>Modul 04. Referensi Kode Barang Baru</td>
			<td WIDTH='1%'>:</td>
			<td >
		...
		<tr>
			<td WIDTH='200'>Modul 05. Mapping Kode Barang</td>
			<td WIDTH='1%'>:</td>
			<td >
		...
		<tr>
			<td WIDTH='200'>Modul 06. Mutasi Barang SOTK Baru</td>
			<td WIDTH='1%'>:</td>
			<td >
		...
		<tr>
			<td WIDTH='200'>Modul 07. Mapping Kode Barang Permen 108</td>
			<td WIDTH='1%'>:</td>
			<td >
	...
	<!--	<tr>
		...
		<tr>
			<td WIDTH='200'>Modul Administrasi / Hak Akses</td>
			<td WIDTH='1%'>:</td>
			<td >
