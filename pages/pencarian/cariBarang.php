...
class cariBarangObj  extends DaftarObj2{	
	 ...
	 $cek = ''; $err=''; $content=''; $json=TRUE;
	  ...
	  switch($tipe){	
		...
		case 'getid':{
				...
				if($err == ''){
					$qry = "SELECT * FROM ref_barang WHERE concat(f1,'.',f2,'.',f,'.',g,'.',h,'.',i,'.',j) = '$kodebarangambil' ";$cek.=$qry;
					...
					if(strlen($kode[6]) >= 3){
						if($kode[6] == '000' || $daqry['nm_barang'] == null){
   ...
   function setPage_OtherScript(){
	...
	$TampilOpt = 
			...
			<td>".
			cmbQuery1("cmbAkun",$cmbAkun,"select f1 as valueCmbAkun , nm_barang from ref_barang where f1 != '' and f2 = '0' and f = '0' and g ='00' and h ='00' and i='00' and j = '000'  ","onChange=\"$this->Prefix.refreshList(true)\" style='width:300px;'",'Pilih','').
			"</td>
			</tr>
			<tr>
			<td style='width:170px;' >KELOMPOK</td><td style='width:10px'>:</td>
			<td>".
			cmbQuery1("cmbKelompok",$cmbKelompok,"select f2 as valueCmbKelompok , nm_barang from ref_barang where f1 = '$cmbAkun' and f2 != '0' and f = '0' and g ='00' and h ='00' and i='00' and j = '000' ","onChange=\"$this->Prefix.refreshList(true)\" style='width:300px;'",'Pilih','').
			"</td>
			</tr><tr>
			<td style='width:170px;' >JENIS</td><td>:</td>
			<td>".
			cmbQuery1("cmbJenis",$cmbJenis,"select f as valueCmbJenis, nm_barang from ref_barang where f1 = '$cmbAkun' and f2 = '$cmbKelompok' and f != '0'  and g ='00' and h ='00' and i='00' and j = '000'","onChange=\"$this->Prefix.refreshList(true)\" style='width:300px;'",'Pilih','').
			"</td>
			</tr><tr>
			<td style='width:170px;'>OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbObyek",$cmbObyek,"select g as valueCmbObyek, nm_barang from ref_barang where f1 = '$cmbAkun' and f2 = '$cmbKelompok' and f = '$cmbJenis'  and g !='00' and h ='00' and i='00' and j = '000'","onChange=\"$this->Prefix.refreshList(true)\" style='width:300px;'",'Pilih','').
			"</td>
			</tr><tr>
			<td style='width:170px;'>RINCIAN OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbRincianObyek",$cmbRincianObyek,"select h as valueCmbRincianObyek, nm_barang from ref_barang where f1 = '$cmbAkun' and f2 = '$cmbKelompok' and f = '$cmbJenis'  and g ='$cmbObyek' and h !='00' and i='00' and j = '000'","onChange=\"$this->Prefix.refreshList(true)\" style='width:300px;'",'Pilih','').
			"</td>
				</tr>
			<tr>
			<td style='width:170px;'>SUB RINCIAN OBYEK</td><td>:</td>
			<td>".
			cmbQuery1("cmbSubRincianObyek",$cmbSubRincianObyek,"select i as valueCmbSubRincianObyek, nm_barang from ref_barang where f1 = '$cmbAkun' and f2 = '$cmbKelompok' and f = '$cmbJenis'  and g ='$cmbObyek' and h ='$cmbRincianObyek' and i != '00' and j = '000'","onChange=\"$this->Prefix.refreshList(true)\" style='width:300px;'",'Pilih','').
			"</td>
				</tr>
			"./*"<tr>
